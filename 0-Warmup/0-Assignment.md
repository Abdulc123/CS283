...
https://github.com/Abdulc123/CS283

4. Briefly describe what you want to get out of this class.

    From this class I want to really understand the low level concepts behind all the systems and programs I use. I also want to get familiar with networks and container managament platforms like Docker and Kubernetes that many real world comapnies use in their workspace. 

5. Briefly describe any concerns you might be having with being successful in this class (if any).

    The only concern I have is my basic understanding of C so far, currently my goal is to get better prepared and understand it better so I can focus on understand the more in depth and lower level workings of systems and programs. I am currently watching videos and creating samll c programs to get a better grasp of this new langauge. 